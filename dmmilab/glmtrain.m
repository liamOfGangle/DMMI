...
%   Overloaded to permit L2 regularisation and combat problem of linear separability. RFH 8/1/08
    ...
    switch net.outfn
        case 'logistic'
            ...
            if ~isfield(net, 'alpha')
                ...
                if isfield(net, 'alpha')& size(net.alpha)==[1 1]
                    Hessian = Hessian + net.alpha*eye(size(Hessian)); % L2 regularisation (RFH)
                end
